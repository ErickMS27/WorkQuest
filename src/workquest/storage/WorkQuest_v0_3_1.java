...
import workquest.storage.Dices_WorkQuest;

import java.util.ArrayList;
import java.util.Scanner;

public class WorkQuest_v0_3_1{
...
private static void menu_races() {
	...
	private static void Dices_WorkQuest(){
		...
		for (int x = 0; x<1; x++) {
			System.out.println("Seu número no D06 é: " + new workquest.storage.Dices_WorkQuest().roll_d06());
		...
		for (int x = 0; x<1; x++) {
			System.out.println("Seu número no D08 é: " + new workquest.storage.Dices_WorkQuest().roll_d08());
		}
		
		roll_d08();
		
		for (int x = 0; x<1; x++) {
			System.out.println("Seu número no D10 é: " + new workquest.storage.Dices_WorkQuest().roll_d10());
		}
		
		roll_d10();
		
		for (int x = 0; x<1; x++) {
			System.out.println("Seu número no D12 é: " + new workquest.storage.Dices_WorkQuest().roll_d12());
		}
