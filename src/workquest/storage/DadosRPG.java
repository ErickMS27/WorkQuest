...
public void exibirResultado() {	
	...
	int x1 = 0;x1<1;x1++)
	{
		System.out.println("Seu número no D04 é: " + new DadosRPG().rolarD04());
	}

	for(
	int x2 = 0;x2<1;x2++)
	{
		System.out.println("\nSeu número no D06 é: " + new DadosRPG().rolarD06());
	}

	for(
	int x3 = 0;x3<1;x3++)
	{
		System.out.println("\nSeu número no D08 é: " + new DadosRPG().rolarD08());
	}

	for(
	int x4 = 0;x4<1;x4++)
	{
		System.out.println("\nSeu número no D10 é: " + new DadosRPG().rolarD10());
	}

	for(
	int x5 = 0;x5<1;x5++)
	{
		System.out.println("\nSeu número no D12 é: " + new DadosRPG().rolarD12());
	}

	for(
	int x6 = 0;x6<1;x6++)
	{
		System.out.println("\nSeu número no D20 é: " + new DadosRPG().rolarD20());
	}
}
