...
public class WorkQuest_v0_7_1 {

	static int atribute_points = 72;

	// Atributos de Char

	static int strength_atribute = 0;
	static int dexterity = 0;
	static int constitution_atribute = 0;
	...
	// Sumário de Aprimoramento Racial
	
	//static int up_dwarf_race;
	//static int up_hill_dwarf_race;
	//static int up_mountain_dwarf_race;
...
//		Ficha do Player
	...
	public static void main(String[] args) {
		...
		while (name_play.isEmpty()) {
			...
			System.out.println("Digite o seu nome de seu jogador:");
		...
		classes.add(
				"6) Druid: é uma classe que possui um forte vínculo com a natureza, podendo se transformar em animais e lançar magias baseadas no ambiente natural.");
		classes.add(
		...
		System.out.println("\nGostaria de reiniciar o sistema (s/n)");
	...
	private static void menu_races() {
		...
		case "1", "Anão", "anão", "Anao", "anao":
			...
			up_dwarf_race = constitution_atribute + 2;
			...
			case "1", "Anão da Colina", "Anão da colina", "anão da colina", "Anao da Colina", "Anao da colina",
					"anao da colina":
						...
						int up_hill_dwarf_race= wisdom+1;
			...
			case "2", "Anão da Montanha", "Anão da montanha", "anão da montanha", "Anao da Montanha",
					"Anao da montanha", "anao da montanha":
						...
						int up_mountain_dwarf_race = strength_atribute+2;
		...
		case "2", "Draconato", "draconato":
			...
			int up_dragonborn_str_race = strength_atribute+2;
			int up_dragonborn_cha_race = charisma+1;
		...
		case "3", "Elfo", "elfo":
			...
			case "1", "Alto Elfo", "Alto elfo", "alto elfo":
				...
				int up_high_elf_race = intelligence+1;
			...
			case "2", "Elfo da Floresta", "Elfo da floresta", "elfo da Floresta", "elfo da floresta", "Bosmer",
				...
				int up_wood_elf_race = charisma+1;
			...
			case "3", "Elfo Negro", "Elfo negro", "elfo negro", "Drow", "drow":
				...
				int up_dark_elf_race = charisma+1;
		...
		case "4", "Gnomo", "gnomo":
			...
			int up_gnome_race = intelligence+2;
			...
			case "1", "Gnomo da Floresta", "Gnomo da floresta", "gnomo da floresta":
				...
				int up_forest_gnome_race = dexterity+1;
			...
			case "2", "Gnomo das Rochas", "Gnomo das rochas", "gnomo das rochas":
				...
				int up_rock_gnome_race = constitution_atribute+1;
		...
		case "5", "Halfling", "halfing", "Hobbit", "hobbit":
			...
			int up_halfling_race = dexterity+2;
			...
			case "1", "Robusto", "robusto":
				...
				int up_stout_halfling_race = constitution_atribute+1;
			...
			case "2", "Pés Peludos", "Pés peludos", "pés peludos", "Pes Peludos", "Pes peludos", "pes peludos":
				...
				int up_lightfoot_halfling_race = charisma+1;
		...
		case "6", "Humano", "humano":
			...
			int up_human_str_race = strength_atribute+1;
			int up_human_dex_race = dexterity+1;
			int up_human_con_race = constitution_atribute+1;
			int up_human_int_race = intelligence+1;
			int up_human_wis_race = wisdom+1;
			int up_human_cha_race = charisma+1;
		...
		case "7", "Meio-Elfo", "Meio-elfo", "meio-elfo", "Meio Elfo", "Meio elfo", "meio elfo":
			...
			int up_half_elf_cha_race = charisma+2;
		...
		case "8", "Meio-Orc", "Meio-orc", "meio-orc", "Meio Orc", "Meio orc", "meio orc":
			...
			int up_half_orc_str_race = strength_atribute+2;
			int up_half_orc_con_race = constitution_atribute+1;
		...
		case "9", "Tiferino", "tiferino", "Tiefling", "tiefling", "Homem-Diabo", "Homem-diabo", "homem-diabo",
			...
			int up_tiefling_int_race = intelligence+1;
			int up_tiefling_cha_race = charisma+2;
	...
	private static void menu_backgrounds() {
		...
		case "10", "Marinheiro", "marinheiro":
			...
			System.out.println("\nCerto, temos diversas variações de Marinheiro, que são:");
		...
		case "13", "Sábio", "sábio", "Sabio", "sabio":
			...
			System.out.println("Informe com qual variação de Sábio você deseja jogar:");
		...
		case "14", "Soldado", "soldado":
			...
			System.out.println("\nCerto, temos diversas variações de Soldado, que são:");
			...
			System.out.println("Informe com qual variação de Soldado você deseja jogar:");
...
// Método de Variação de Antecedente
...
// Sistema de Dados para Atributos
	...
	// Sistema de Preenchimento de Atributos e Afins
	...
	public static void system_add_atributes() {
		...
		if (enter_system_atributes == 1) {
			...
			System.out.println(
					"Certo, vamos começar a jogar os seus 24 dados de 6 lados (24D6) para seu respectivos atributos\n");

			System.out.println("Digite abaixo o comando: Jogar.");
			...
			case "Jogar", "jogar", "Jogar dados", "jogar dados", "Rolar", "rolar", "Rolar dados", "rolar dados",
					"Jogardados", "jogardados", "Rolardados", "rolardados":
				...
				for (int i = 0; i < max_value_atribute; i++) {
					...
					for (int j = 0; j < 4; j++) {
						plus_dice[j] = random.nextInt(6) + 1;
					}
				...
				for (int i = 0; i < 1; i++) {
					...
					System.out.println("Seu valor de Destreza é: " + atributes_value[1] + "\n");
					System.out.println("Seu valor de Constituição é: " + atributes_value[2] + "\n");
					System.out.println("Seu valor de Inteligência é: " + atributes_value[3] + "\n");
					System.out.println("Seu valor de Sabedoria é: " + atributes_value[4] + "\n");
					System.out.println("Seu valor de Carisma é: " + atributes_value[5] + "\n");
				}

				System.out.println(
						"A partir dos dados obtidos dos atributos acima, esses serão os valores dos seus modificadores de atributos:\n");
				calc_mod_str(atributes_value[0]);
				System.out.println("");
				calc_mod_dex(atributes_value[1]);
				System.out.println("");
				calc_mod_con(atributes_value[2]);
				System.out.println("");
				calc_mod_int(atributes_value[3]);
				System.out.println("");
				calc_mod_wis(atributes_value[4]);
				System.out.println("");
				calc_mod_cha(atributes_value[5]);
				break;

			default:
					System.out.println("\nOpção inválida, por favor digite uma das opções acima para novamente, escolher um sistema de distruibuição de pontos de atributos:\n");
				system_add_atributes();				
				break;
	...
	// Sistemas de Aprimoramentos de Atributos Raciais
