...
public class Dices_WorkQuest {
	...
	for (int x = 0; x<1; x++) {
		System.out.println("\nSeu número no D06 é: " + new Dices_WorkQuest().roll_d06());
	}
	
	for (int x = 0; x<1; x++) {
		System.out.println("\nSeu número no D08 é: " + new Dices_WorkQuest().roll_d08());
	}
	
	for (int x = 0; x<1; x++) {
		System.out.println("\nSeu número no D10 é: " + new Dices_WorkQuest().roll_d10());
	}
	
	for (int x = 0; x<1; x++) {
		System.out.println("\nSeu número no D12 é: " + new Dices_WorkQuest().roll_d12());
	}
	
	for (int x = 0; x<1; x++) {
		System.out.println("\nSeu número no D20 é: " + new Dices_WorkQuest().roll_d20());
	}
