...
public void atacar(workquest.storage.RPG_test_0_1 outroPersonagem) {
...
public void conjurarMagia(workquest.storage.RPG_test_0_1 outroPersonagem, int custoDeMagia, int danoDaMagia) {
